...
with open("baseTestePrinc.csv", encoding="utf-8") as f:
...
def metricas(tabela):
    ...
    print("Media de precisao: ", mean(precisions))
    print("\nMedia de Recalls: ", mean(recalls))
    print("\nMedia de Acuracia:", mean(accuracies))
    print("------------------------------------------")
